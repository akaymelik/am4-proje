/**
 * planes.js: AM4 Kapsamlı Uçak Veritabanı (Yolcu + Kargo)
 * Bu dosya sadece uçak verilerini içerir, rotalar routes.js dosyasındadır.
 */
const aircraftData = {
    // --- BÖLGESEL VE KISA MESAFE (Regional) ---
    ...
    "Embraer 195-E2": { type: "passenger", capacity: 146, fuel_consumption: 0.60, range: 4800, cruise_speed: 870, price: 5500000 },

    // --- ORTA MESAFE (Narrow Body) ---
    ...
    "Boeing 737 MAX 10": { type: "passenger", capacity: 230, fuel_consumption: 0.80, range: 6110, cruise_speed: 839, price: 10500000 },
    ...
    "Boeing 757-200": { type: "passenger", capacity: 239, fuel_consumption: 1.10, range: 7200, cruise_speed: 850, price: 18000000 },
    "MC-21-400": { type: "passenger", capacity: 230, fuel_consumption: 1.05, range: 5500, cruise_speed: 870, price: 33750000 },

    // --- UZUN MESAFE (Wide Body) ---
    "Boeing 767-300ER": { type: "passenger", capacity: 350, fuel_consumption: 2.20, range: 11000, cruise_speed: 851, price: 35000000 },
    ...
    "Boeing 787-10": { type: "passenger", capacity: 440, fuel_consumption: 1.85, range: 11910, cruise_speed: 903, price: 145000000 },
    ...
    "Boeing 747-400": { type: "passenger", capacity: 416, fuel_consumption: 10.2, range: 13450, cruise_speed: 912, price: 150000000 },
    ...
    "Boeing 747-400ERF": { type: "cargo", capacity: 270000, fuel_consumption: 9.80, range: 9200, cruise_speed: 912, price: 155000000 },
