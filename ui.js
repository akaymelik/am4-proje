 ...
 * - Hibrit Skor (%30 Verimlilik + %70 Günlük Kâr) görselleştirme.
 * - Önerilerde Fiyat ve Tek Uçuşluk Kâr bilgisi.
 * - Rota Analizinde günlük kârın altında uçuş başı kâr gösterimi.
 */

const UI = {
    /**
     * Sayfalar arasında geçiş yapar ve ilgili verileri temizler.
    ...
    showPage: function(pageId) {
        ...
        // Rota sayfalarındaysak seçim kutularını doldur
    ...
    setGameMode: function(mode) {
        ...
        const containers = ['paxRouteResult', 'cargoRouteResult', 'paxPlaneResult', 'cargoPlaneResult'];
    ...
    /**
     * Bütçeye göre en verimli ve kârlı uçakları hibrit puanlamaya göre listeler.
    ...
    /**
     * Seçilen uçak için rota analizini listeler.
     * Günlük kârın altında "Uçuş Başı Kâr" bilgisini gösterir.
     * @param {string} cat - 'pax' veya 'cargo'
     */
    renderRouteAnalysis: function(cat) {
        ...
        // Logic üzerinden en kârlı rotaları getir
        ...
        resultDiv.innerHTML = `<h3 style="margin: 20px 0 15px 0;">En Karlı Rotalar (${currentMode.toUpperCase()})</h3>` + topRoutes.map((r, i) => {
            ...
            <div class="route-card">
                <div style="display: flex; justify-content: space-between; align-items: start; margin-bottom: 12px;">
                    <strong style="font-size: 1.05rem; flex: 1;">#${i + 1} ${r.origin} ➔ ${r.destination}</strong>
                ...
                <div style="font-size: 0.85rem; color: var(--text-muted); margin-bottom: 8px;">
                    <span style="font-weight: 700; color: var(--text);">Pazar Talebi (Demand):</span>
                    Y:${r.demand.y} | J:${r.demand.j} | F:${r.demand.f}
                </div>

                <div style="background: var(--info-bg); padding: 12px 15px; border-radius: 12px; margin-bottom: 15px; display: flex; justify-content: space-between; align-items: center; border: 1px solid rgba(37, 99, 235, 0.15);">
                    <div>
